...
for seed in np.arange(100)+5:
    ...
    torch.save(final_clas_adv.state_dict(), "/Users/mghrear/data/ML_data/patch/ensemble_NHP1_early_QualCuts/classifier_adv_2021_v9_pass5_run"+str(seed)+"_limited.pt")
    torch.save(final_classifier.state_dict(), "/Users/mghrear/data/ML_data/patch/ensemble_NHP1_QualCuts/classifier_adv_2021_v9_pass5_run"+str(seed)+"_limited.pt")
