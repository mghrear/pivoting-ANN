...
data_dir = '/Users/mghrear/data/HPS_data/ensemble_FakeGen_1pt05_kaon/'
...
for p in Path(data_dir).iterdir():
    ...
    plt.legend()
    plt.savefig('/Users/mghrear/Desktop/Ensemble_study/original_1pt05_kaon/data_plots/'+str(run_number)+'.png')
